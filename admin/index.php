...
$q=mysqli_query($conn,"select name from admin ");
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"style="background:pink"">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Welcome, <?php echo $adname;?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=manage_admin"><span class="glyphicon glyphicon-user"></span> Manage Admin</a></li>
            <li><a href="index.php?page=manage_department"><span class="glyphicon glyphicon-user"></span> Manage Department</a></li>
